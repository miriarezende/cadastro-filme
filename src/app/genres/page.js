  ...
  return (
    <>
      ...
      <div className="p-4 sm:ml-64">
        <Header
          title={!showForm ? "Gêneros" : (gender ? "Editando Gênero" : "Cadastrando Gênero")}
          onClickAddButton={() => {
            setGender(null);
            setShowForm(true);
            resetInputs();
        ...
        <div className="flex justify-center mt-5">
          <div>
            <button
              ...
              className="text-white bg-pink-800 hover:bg-pink-900 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 mb-2"
            >
              Cancelar
            </button>
          </div>
          <div>
            <button
              type="submit"
              className="text-white bg-emerald-600 hover:bg-emerald-700 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 mb-2 ml-3"
            >
              Salvar
            </button>
          </div>
